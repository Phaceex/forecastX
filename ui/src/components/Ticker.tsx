...
const Ticker: React.FC<TickerProps> = ({ markets }) => {
  const items = markets.map(m => ({
    label: `${m.fixture.homeCode} vs ${m.fixture.awayCode}`,
    homeCode: m.fixture.homeCode,
    awayCode: m.fixture.awayCode,
    homeLogo: m.fixture.homeLogo,
    awayLogo: m.fixture.awayLogo,
    yes: m.yesPrice,
    no: m.noPrice,
    status: m.fixture.status,
    score: m.fixture.score,
  }));
